...
### Obs.: tentativa de implementar um loop para executar todos os augs (incompleto ainda)
...
activate_loss         = [1]
activate_optimizer    = [1]
activate_augmentation = []



list_loss         = ['BCELoss', 'L1Loss', 'MSELoss', 'HuberLoss', 'SmoothL1Loss']
list_optimizer    = ['Adam']
list_augmentation = ['CLAHE', 'Downscale', 'Equalize', 'HueSaturationValue', 'ISONoise', 'MultiplicativeNoise',
...
dataset_name="320_ORCA512" # prefix name used in the model file
loss_function="BCELoss" # BCELoss, L1Loss, MSELoss, HuberLoss, SmoothL1Loss
optimizer_algorithm="Adam"
