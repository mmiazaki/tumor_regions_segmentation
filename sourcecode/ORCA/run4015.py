...
trained_model_version = "4015_ORCA_640x640_Epoch-55_Images-4181_Batch-1_HuberLoss_Adam_random_8_operations"
...
dataset_name="4015_ORCA" # prefix name used in the model file
loss_function="HuberLoss" # BCELoss, L1Loss, SmoothL1Loss, MSELoss, HuberLoss
